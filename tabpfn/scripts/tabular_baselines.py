...
def catboost_metric(x, y, test_x, test_y, cat_features, metric_used, seed, max_time=300, no_tune=None):
    x, y, test_x, test_y = preprocess_impute(x, y, test_x, test_y
                                             , one_hot=False
                                             , cat_features=cat_features
                                             , impute=False
...
def xgb_metric(x, y, test_x, test_y, cat_features, metric_used, seed, max_time=300, no_tune=None):
    import xgboost as xgb
    # XGB Documentation:
